<template>
  <div class="article-container">
    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">根据筛选数据还有{{totalCount}}条数据</div>
      <!-- 数据列表 -->
      <!-- table 表格组件
         把需要展示的数组列表数据绑定给table组件的data属性
      ...
      >
        <el-table-column prop="" label="封面" width="180"> 
            <template slot-scope="scope">
              ...
              而本地图片必须在打包的时候就存在。
             -->
                <!-- <img :src="scope.row.cover.images[0] || 'no-cover.gif'" class="article-cover" alt=""> -->
                <!-- <img 
